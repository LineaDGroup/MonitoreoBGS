<?php namespace App\Http\Controllers;
	...
	class AdminBioCentroController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
			$this->form[] = ['label'=>trans('biobarica.labels.description'),'name'=>'descripcion','type'=>'text','validation'=>'required|min:1|max:255','width'=>'6'];
	    ...
	    */
		...
		if(!($me->id_cms_privileges === 1 || $me->id_cms_privileges === 2) ){
		     $query->where('bio_centro.id_cms_users', $me->id);
		}
